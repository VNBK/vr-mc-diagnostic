...
void MotorProfileView::setParams(const MotorParams& mp)
{
    ...
    setRow(r++, tr("Min voltage"),    QString::number(mp.min_vol),     tr("V"));
    setRow(r++, tr("Max voltage"),    QString::number(mp.max_vol),     tr("V"));
    setRow(r++, tr("Rated current"),  QString::number(mp.rated_cur),   tr("A"));
    setRow(r++, tr("Max current"),    QString::number(mp.max_cur),     tr("A"));
    setRow(r++, tr("Stall current"),  QString::number(mp.stall_cur),   tr("A"));
    setRow(r++, tr("Stall time"),     QString::number(mp.stall_time_cur), tr("s"));
}
