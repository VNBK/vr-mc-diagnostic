...
void ObjectDictionaryDialog::buildCatalog()
{
    ...
    add(0x2050, 0, "Fault protection: count",        "u8",  1, "",     true,  kCatMfr);
    add(0x2050, 1, "Stall current",                  "u32", 4, "mA",   false, kCatMfr);
    add(0x2050, 2, "Stall time",                     "u32", 4, "ms",   false, kCatMfr);
    add(0x2050, 3, "Stall velocity gate",            "f32", 4, "rad/s",false, kCatMfr);
    add(0x2050, 4, "Over-current trip",              "f32", 4, "A",    false, kCatMfr);
    add(0x2050, 5, "Over-load current",              "f32", 4, "A",    false, kCatMfr);
    add(0x2050, 6, "Over-load time",                 "f32", 4, "s",    false, kCatMfr);
    add(0x2050, 7, "Over-voltage trip",              "f32", 4, "V",    false, kCatMfr);
    add(0x2050, 8, "Under-voltage trip",             "f32", 4, "V",    false, kCatMfr);
    add(0x2050, 9, "Under-voltage time",             "f32", 4, "s",    false, kCatMfr);
    add(0x2050, 10, "Loss-phase min",                "f32", 4, "A",    false, kCatMfr);
    add(0x2050, 11, "Loss-phase time",               "f32", 4, "s",    false, kCatMfr);
    add(0x2050, 12, "Unbalance trip",                "f32", 4, "A",    false, kCatMfr);
    add(0x2060, 0, "Angle offsets: count",           "u8",  1, "",     true,  kCatMfr);
    add(0x2060, 1, "Commutation offset",             "f32", 4, "rad",  false, kCatMfr);
    add(0x2060, 2, "Position offset (TMAG sin off)",  "f32", 4, "",     false, kCatMfr);
    add(0x2060, 3, "Position offset_0 (TMAG sin gain)","f32", 4, "",    false, kCatMfr);
    add(0x2060, 4, "Position offset_1 (TMAG cos off)", "f32", 4, "",    false, kCatMfr);
    add(0x2060, 5, "Position offset_2 (TMAG cos gain)","f32", 4, "",    false, kCatMfr);
